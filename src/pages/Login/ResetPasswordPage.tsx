...
import { authServicePassword } from '../../services/authService';
...
const ResetPasswordPage: React.FC = () => {
  ...
  useEffect(() => {
    const validateToken = async () => {
      ...
      try {
        const validation = await authServicePassword.validateResetToken(token);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await authServicePassword.resetPassword(token, password);
      ...
      const errorMessage = err.response?.data?.detail || err.response?.data?.message || 'Error al restablecer la contraseña';
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full text-center">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <h3 className="text-lg font-medium text-red-800 mb-2">Enlace inválido</h3>
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link to="/" className="inline-flex items-center mb-8">
            ...
            <span className="ml-2 text-2xl font-bold text-gray-900">DocsFlow</span>
          </Link>
